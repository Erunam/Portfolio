...
-- Created on: 2010-08-14 22:50:58
-- Diagram Version: 1.141
-- =============================================================================
...
CREATE TABLE `ComponentConfiguration` (
  ...
  UNIQUE INDEX `ComponentConfiguration`(`ProductPart`, `ComponentPart`, `ComponentID`),
...
CREATE TABLE `WorkmanshipsDetails` (
  ...
  `ComponentID` int(11) UNSIGNED DEFAULT '0',
  `Quantity` float(9,3),
  UNIQUE INDEX `WorkmanshipDetails`(`WorkmanshipName`, `ProductPart`, `ComponentID`),
...
CREATE TABLE `ComponentDetails` (
  ...
  UNIQUE INDEX `ComponentDetails`(`ComponentID`, `ComponentPart`, `PartID`),
  CONSTRAINT `ComponentInDetails` FOREIGN KEY (`ComponentID`)
    REFERENCES `ComponentAndPart`(`ComponentID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
CREATE TABLE `ProductConfiguration` (
  ...
  UNIQUE INDEX `ProductConfiguration`(`ProductLine`, `CategoryID`, `SubcategoryID`, `StandardWorkmanship`),
...
CREATE TABLE `Product` (
  ...
  `ManufacturingTime` float(9,3) COMMENT 'uaktualniane - WP ca³kowite',
  `MaterialCost` float(9,3) COMMENT 'uaktualniane - koszt materia³u',
  `Description` text,
...
CREATE TABLE `ProductDetails` (
  ...
  UNIQUE INDEX `ProductDetails`(`ProductID`, `ProductPart`, `ComponentID`),
  CONSTRAINT `ProductInDetails` FOREIGN KEY (`ProductID`)
